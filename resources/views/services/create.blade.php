                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('service.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="service_name" type="text" class="form-control @error('service_name') is-invalid @enderror" name="service_name" value="{{ old('service_name') }}" required autocomplete="name" autofocus>
